<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex">
            ...
            <div class="flex items-center mb-4">
                <input id="type" type="radio" name="type" value="Organisation" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                <label for="type" class="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Organisation
                </label>
            </div>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
                {{ __('Deja un compte?Conectez-vous.') }}
            </a>
